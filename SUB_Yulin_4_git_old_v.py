...
#sfe = [2.1e-4, 1.5e-4, 4.2e-4]   
sfe1 = 1.14286e-3   #(0.00081+0.00059+0.00192+0.00022+0.00046+0.00013+0.00387)/7
sfe = [sfe1, 2.1e-4, 1.5e-4, 4.2e-4]                         # elastic skeletal storage coefficient
...
# col 1 的水頭剖面隨時間變化
plot_kper=[0, 1, 3, 10]        # 這樣設是為了下面畫well profile
...
ax5.plot(times, subs_t[:,50], "-o", label="Total Subsidence")
ax5.plot(times, comp1_t[:,50], "-o", label="Layer 1 compaction")
ax5.plot(times, comp2_t[:,50], "-o", label="Layer 2 compaction")
ax5.plot(times, comp3_t[:,50], "-o", label="Layer 3 compaction")
ax5.plot(times, comp4_t[:,50], "-o", label="Layer 4 compaction")
